...
Výrobní B2B klient (CNC zpracování, 500+ zakázek/měsíc) byl závislý na proprietárním binárním formátu .VCF (Ruida/VCutWorks) bez veřejné specifikace a SDK a na tacitním know-how odcházejícího klíčového technika.
...
*Live demo: *[vcf-parser-demo-537446704644.europe-west1.run.app](https://vcf-parser-demo-537446704644.europe-west1.run.app)
...
- Vývoj a provoz off-grid technického uzlu (35 m²) — převod 14 let praktických zkušeností s energetikou a stavbou na dokumentovaný, funkční systém infrastruktury: FVE 1,9 kWp, LiFePO4 8S2P 630 Ah, BMS s aktivním balancováním. Stejný mechanismus formalizace implicitních zkušeností do explicitního systému, aplikovaný na fyzickou infrastrukturu.
...
**CNC operátor (vodní paprsek) — Japs Elements, Praha  |  2025 – 2026**
